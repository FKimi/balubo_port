...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'process.env.VITE_GEMINI_API_KEY': JSON.stringify(env.VITE_GEMINI_API_KEY || '***REMOVED***'),
      'process.env.VITE_LINKPREVIEW_API_KEY': JSON.stringify(env.VITE_LINKPREVIEW_API_KEY || '***REMOVED***'),
    },
    server: {
      proxy: {
